...
if args.natask in ['nounpp_animate_accusative', 'nounpp_animate_unaccusative', 'nounpp_inanimate_unaccusative']:
    ...
    features = {}
    if args.natask in ['nounpp_animate_accusative', 'nounpp_animate_unaccusative']:
        features['N1_animacy'] = ['animate'] # SUBJET IS ANIMATE
    elif args.natask == 'nounpp_inanimate_unaccusative':
        features['N1_animacy'] = ['inanimate'] # SUBJET IS INANIMATE
    ...
    if args.natask == 'nounpp_animate_accusative':
        features['V1_argument_struct'] = ['accusative'] # V1 IS ACCUSATIVE
    elif args.natask in ['nounpp_inanimate_unaccusative', 'nounpp_animate_unaccusative']:
        features['V1_argument_struct'] = ['unaccusative'] # V1 IS UNACCUSATIVE
    ...
    while not counter_fullfilled(counter, args.n):
        ...
        if args.natask in ['nounpp_animate_accusative', 'nounpp_animate_unaccusative']:
            ...
            N1_animacy = 'inanimate' # SUBJECT IS INANIMATE
            N1_group = np.random.randint(3)
        N1s = Words['nouns'][N1_animacy][N1_group][N1_gender][N1_number]#[0:num_nouns]
        ...
        if N2_animacy == 'animate':
            N2_group = 0
        elif N2_animacy == 'inanimate':
            N2_group = np.random.randint(3) # There are 3 inanimage groups
        N2s = Words['nouns'][N2_animacy][N2_group][N2_gender][N2_number]#[0:num_nouns]
        ...
        if N3_animacy == 'animate':
            N3_group = 0
        elif N3_animacy == 'inanimate':
            N3_group = np.random.randint(3) # There are 3 inanimate groups
        N3s = Words['nouns'][N3_animacy][N3_group][N3_gender][N3_number]#[0:num_nouns]
        ...
        V1s = Words['verbs'][N1_animacy][N1_group][V1_argument_struct][N1_gender][N1_number]#[0:num_nouns]
